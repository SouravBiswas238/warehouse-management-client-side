        ...
        <div className='m-2'>
            ...
            <div className='row'>
                <div className='col-md-6 border-end'>
                    ...
                    <p> <span className='text-success fs-5 bg-light border p-1'>SQL:</span> SQL databases defines and manipulates data based structured query language.  SQL is one of the most versatile and widely-used  which makes it a safe choice for great complex queries.But from other side it can be restrictive.  . Also all of your data must follow the same structure. </p>
